...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 SuiteCRM 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://docs.suitecrm.com/admin/installation-guide/)）：
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| suitecrm | 9001 | 浏览器访问 SuiteCRM | Y |
| elasticsearch | 9200 | elasticsearch HTTP service | Y |
## 文档

[SuiteCRM 管理员手册](https://support.websoft9.com/docs/suitecrm)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [SuiteCRM 企业级支持版](https://apps.websoft9.com/suitecrm) 
